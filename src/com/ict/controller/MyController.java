...
import com.ict.model.ReplyCommand;
import com.ict.model.ReWriteOkCommand;
...
public class MyController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (cmd) {
			...
			case "re_write"		: comm = new ReplyCommand();		break;
			case "rewrite_ok"	: comm = new ReWriteOkCommand();	break;
